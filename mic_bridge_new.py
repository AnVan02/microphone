...
# - Luồng: Python → CABLE Input → CABLE Output → Chrome
...
print(f"\nCách hoạt động:")
print(f"  Python → CABLE Input → CABLE Output → Chrome")
print(f"\nCác bước:")
print(f"1. Code này phát audio vào: {device_name}")
print(f"2. Trong Chrome: Click 🔒 → chọn 'CABLE Output' làm microphone")
print(f"3. Mở Chrome → cho phép microphone → chọn 'CABLE Output'")
print(f"4. Nói trên điện thoại → Chrome sẽ nhận được!")
print(f"{'='*60}")
